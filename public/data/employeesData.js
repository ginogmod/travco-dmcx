const employees = [
  // General Manager
  { id: 1, name: 'Paolo Nocerino', department: 'G.M', username: 'paolo.nocerino', password: '123456', role: 'General Manager' },
  
  // Inbound Department
  { id: 2, name: 'Shatha Farouq Mohammad Khudr', department: 'Inbound', username: 'shatha.khudr', password: '123456', role: 'Department Head' },
  { id: 3, name: 'Najma Mohammad Atiyeh Abdulhaq', department: 'Inbound', username: 'najma.abdulhaq', password: '123456', role: 'Reservations Agent' },
  { id: 4, name: 'Laith Hamad Mohammad Al-Jibawi', department: 'Inbound', username: 'laith.aljibawi', password: '123456', role: 'Reservations Agent' },
  ...
  { id: 7, name: 'Yanal Jihad Hasan Al-Samadi', department: 'Inbound', username: 'yanal.alsamadi', password: '123456', role: 'Reservations Agent' },
  { id: 8, name: 'Omar Khalil Abu Asba', department: 'Inbound', username: 'omar.abuosba', password: '123456', role: 'Reservations Agent' },
  ...
  { id: 10, name: 'Osama Mohammad Awad Al-Rifai', department: 'Inbound', username: 'osama.alrifai', password: '123456', role: 'Reservations Agent' },
  ...
  { id: 12, name: 'Nermin Haddadin', department: 'Inbound', username: 'nermin.haddadin', password: '123456', role: 'Reservations Agent' },
  
  // Operations Department
  { id: 13, name: 'Suhail Mahmoud Saleh Al-Qassas', department: 'Operation', username: 'suhail.alqassas', password: '123456', role: 'Operations Agent' },
  ...
  { id: 23, name: 'Mohammad Sobhi Ali Saif', department: 'Accounting', username: 'mohammad.sobhi', password: '123456', role: 'Department Head' },
